    ...
    <AppShell sidebar={<CompanySidebar />}>
      <Space direction="vertical" size="middle" style={{ width: '100%' }}>
        <div>
          ...
          <Text type="secondary">Run JV RODTP process and view date-wise generated rows.</Text>
        </div>
        ...
        <Table
          ...
          size="small"
          locale={{ emptyText: 'No JV RODTP dates found.' }}
        />
      </Space>

      <Modal
        title={`JV RODTP — ${viewModal.dayKey || '—'}`}
        open={viewModal.open}
        onCancel={() =>
