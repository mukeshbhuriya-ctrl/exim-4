...
import { Button, Input, Layout, Select, Space, Table, Typography, message, ConfigProvider, Card } from 'antd'
...
export function JvDbkFormatContent() {
  ...
  return (
    <>
      <Space direction="vertical" size={16} style={{ width: '100%', minWidth: 0, marginTop: -8 }}>
        <PageHeader
          title="JV DBK Format"
          description={`Configure posting/account fields and row-level mapping. System headers are locked: ${SYSTEM_HEADERS.join(', ')}`}
          actions={
